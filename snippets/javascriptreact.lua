-- Tailwind UI — component snippets for Neovim + LuaSnip
-- File: ~/.config/nvim/snippets/javascriptreact.lua
--
-- Type C in insert mode — your completion menu lists every snippet.
-- Select one and press <Tab> to expand.
--
-- Prefixes:
--   Clogin         Login Form
--   Creg           Registration Form
--   Ccontact       Contact Form
--   Cinputs        Input States
--   Cnavbar        Navbar
--   Csidebar       Sidebar Nav
--   Cprofile       Profile Card
--   Cpricing       Pricing Card
--   Cbuttons       Buttons
--   Cmodal         Modal
--   Ctoast         Toast
--   Ctable         Table
--   Chero          Hero Section
--   Cfeatures      Feature Section
--   Cdashboard     Dashboard Layout
--   Cdivider       Section Divider
--   Cfooter        Footer
--   Clayouts       Layout Patterns
